...
<script type="text/javascript">
	...
	//删除文档
	function delFileByPid(did,address){
		var res = confirm("你确认要删除吗？");
		if(res){
		    $.post(
		    "${pageContext.request.contextPath}/deleteFileById",
		    {"did":did,"address":address},
		    function(data){
		    	if(data.failInfo == "true"){
		    		alert("删除成功");
		    		window.location.href = "${pageContext.request.contextPath}/findAllMyDocument";
		    	}else{
		    		alert("删除失败!");
		    	}	    	
		    },
	...
	//重命名
	function rename(did){
		var newname = prompt("请输入新的文档名?"); 		
		window.location.href = "${pageContext.request.contextPath}/updateFileName?did="+did+"&newname="+newname+"";    	    	
		
	}
	
	//共享到
	function shareToPublic(did){
		var res = confirm("你确认要共享给所有人吗？")
		if(res){
			window.location.href ="${pageContext.request.contextPath}/ShareToPublic?did="+did+"";
		}
	...
	<div class="listBar" >
		<div class="panel panel-default">
			<div class="panel-body">		
				...
				<form id="myForm" class="navbar-form navbar-left" role="search" style="width: 100%"
					action="${pageContext.request.contextPath}/findAllMyDocument">
					<!-- 当前页的隐藏域 -->
							...
							<div class="container-fluid" style="padding-top: 10px">
								...
								<div class="collapse navbar-collapse"
									...
									<ul class="nav navbar-nav navbar-left">
										<li><div class="form-group"><input type="text" name="filename"
										...
										<li>
											<button type="button" class="btn btn-primary"
												onclick="addFile()" style="display: block;margin-left: 600px">
					...
					<table class="table table-hover table-striped">
						...
						<tbody>
							<c:forEach items="${pageBean.documentlist }" var="document"
								varStatus="i">
								<tr>
									<td>${i.count}</td>
									...
									<td><a href="javascript:;"
										onclick="shareToPublic('${document.did }')"> <span
											class="glyphicon glyphicon-share" aria-hidden="true"></a>
									</td>
									<td><a href="javascript:;"
										onclick="rename('${document.did }')"> <span
											class="glyphicon glyphicon-pencil" aria-hidden="true"></button></a>
									</td>
									<td><a href="jscript:;"
										onclick="delFileByPid('${document.did }','${document.address }')">
					...
					<nav aria-label="...">
						<ul class="pager">
							<li>共[${pageBean.totalFileCount }]条记录,每页显示 
